...
# -*- coding: utf-8 -*-
#
# pplt documentation build configuration file, created by
...
latex_documents = [
    ('index', 'pplt.tex', 'pplt Documentation',
...
texinfo_documents = [
    ('index', 'pplt', 'pplt Documentation',
     'International AudioLabs Erlangen', 'pplt',
